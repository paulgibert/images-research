...
mkdir $DIR
mkdir $DIR/reports
python3 scripts/1_scan_images.py -i images.json -r $DIR/reports

# Stage 2 - Build data sets from scan reports
mkdir $DIR/data-sets
python3 scripts/2_build_datasets.py -r $DIR/reports -o $DIR/data-sets

# Stage 3 - Generate figures and summary statistics from data sets
mkdir $DIR/analysis
python3 scripts/3_analyze.py -d $DIR/data-sets/agg.csv -o $DIR/analysis
